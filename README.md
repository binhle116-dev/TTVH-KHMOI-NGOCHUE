...
- Ứng dụng đọc CSV từ Google Sheet qua URL cấu hình trong [src/App.jsx](src/App.jsx): `CSKH_CSV_URL`.
...
Khai báo hằng số trong [src/App.jsx](src/App.jsx):
...
- [src/App.jsx](src/App.jsx): logic xử lý dữ liệu, render dashboard, xuất file.
- [src/App.css](src/App.css): style giao diện.
- [src/index.css](src/index.css): global style/theme.
- [src/data/seedRows.json](src/data/seedRows.json): dữ liệu SLA mặc định.
- [src/data/laborShortage.json](src/data/laborShortage.json): dữ liệu thiếu lao động phát.
- [CHANGELOG_INTERNAL.md](CHANGELOG_INTERNAL.md): log thay đổi nội bộ.
